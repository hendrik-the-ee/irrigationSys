...
import { normalizeProperty, EMPTY_ARGS, PrimitiveReference, UNDEFINED_REFERENCE, dynamicAttribute, SimpleDynamicAttribute, NULL_REFERENCE, curry, getDynamicVar, clientBuilder, DOMChanges, DOMTreeConstruction, inTransaction, JitRuntime, renderJitMain, rehydrationBuilder } from '@glimmer/runtime';
...
const Component = CoreView.extend(ChildViewsSupport, ViewStateSupport, ClassNamesSupport, TargetActionSupport, ActionSupport, ViewMixin, {
  ...
  [PROPERTY_DID_CHANGE](key, value$$1) {
    ...
    if (reference !== undefined && reference[UPDATE_REFERENCED_VALUE] !== undefined) {
      reference[UPDATE_REFERENCED_VALUE](arguments.length === 2 ? value$$1 : get(this, key));
    }
  },
