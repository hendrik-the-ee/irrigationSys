    ...
    try {
        ...
        for (let i = 0; i < summary.groupedNodes.length; i++) {
            ...
            if (group.totalSelfTime > msThreshold) {
                ...
                const timeColumn = pad(Math.floor(group.totalSelfTime) + 'ms' + averageStr, MAX_VALUE_CELL_LENGTH);
        ...
        cumulativeLogLines.unshift(pad('Slowest Nodes (totalTime >= ' + pcThreshold * 100 + '%)', MAX_NAME_CELL_LENGTH) +
            ' | ' +
